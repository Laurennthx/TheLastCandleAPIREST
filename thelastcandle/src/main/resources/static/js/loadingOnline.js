class LoadingOnlineScene extends Phaser.Scene {
    constructor() {
        super({ key: 'LoadingOnlineScene' });
    }
    ...
    preload() {
        ...
        this.load.once('filecomplete-image-LoadingOnlineBG', () => {
            this.add.image(this.scale.width / 2, this.scale.height / 2, 'LoadingOnlineBG')
                .setOrigin(0.5)
